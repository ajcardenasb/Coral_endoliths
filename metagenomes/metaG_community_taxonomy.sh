...
/home/cardena/software/bbmap/bbsplit.sh in=~/projects/endoliths/metaGs/community_analyses/functional_profiles/prodigal/endoliths.assembly.fna  ref=./coral_genomes/gasp_final_1.0.fasta,./coral_genomes/plut_final_2.1.fasta basename=endoliths_coral_%.fasta outu=endoliths_nonCoral.fasta threads=64
